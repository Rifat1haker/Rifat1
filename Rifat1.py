...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/Rifat1haker/Rifat/blob/main/Rifat.txt").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        ...
        print ("\n")
        os.system("espeak \"assalamualaikum ,I am HACK ROBOT and my boss is RIFAT Sir this tool is paid because 100% ok id just now login\"")
